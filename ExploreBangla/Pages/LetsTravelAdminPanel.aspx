<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="LetsTravelAdminPanel.aspx.cs" Inherits="ExploreBangla.Pages.LetsTravelAdminPanel" %>
        ...
        <table align="center" style="width: 100%; height: auto; background-color: rgba(0, 0, 0, 0.41);">
            ...
            <tr>
                <td align="center" style="width: 50%; height: 100%; vertical-align: middle; padding: 30px; background-color: rgba(0, 0, 0, 0.44)">
                    <h1 style="color: white; font-size: 30px; font-family: Roboto; font-weight: bold">
                        <br />
                        <span style="font-size: 70px; color: #d00040; text-shadow: 0 0 7px Black">Lets<span style="color: #4285f4">T</span>ravel<span style="font-size: 30px">.com.bd</span></span><br />
                        AdminPanel</h1>
                </td>
                    ...
                    <table align="center" style="width: 100%; border-radius: 20px; background-color: rgba(0, 0, 0, 0.10); height: auto; padding: 20px; border-collapse: collapse">
                        <tr>
                            <td align="center" style="width: 100%; height: auto;">
                                <h1 style="color: white; font-family: Roboto">Admin Login
                                </h1>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table style="width: 100%; height: auto;">
                                    <tr style="border: 1px solid black; border-radius: 5px">
                                        ...
                                        <td align="left" style="width: 100%; padding: 5px; background-color: white">
                                            <asp:TextBox ID="EmailIDTextBox" placeholder="Enter Your Email ID" runat="server" BorderStyle="None" Height="33px" Width="90%"></asp:TextBox>
